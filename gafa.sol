...
contract Gafa is Context, IERC20, Ownable
{
    ...
    uint256 private _tTotal = 1_000_000_000 * 10**9; //1 Billion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Gafa";
    string private _symbol = "GAFA";
    ...
    uint256 public _GafalaFee = 2;
    uint256 private _previousGafalaFee = _GafalaFee;
    
    uint256 public totalBuyFee = _taxFee.add(_liquidityFee).add(_marketingFee).add(_GafalaFee); //5% Total Buy Fee
    
    
    

    address payable public marketingWallet =  payable(0x96e59516fDd189E552339bEB24687c18b1c0183a);
    address payable public GafalaWallet =  payable(0x88640d01e699eFC01083796EBb987306877CE4c8);
    ...
    constructor () 
    {
        ...
        _isExcludedFromWhale[GafalaWallet]=true;
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
       ...
       // _tFeeTotal = _tFeeTotal.add(tFee);
        ...
        _tOwned[marketingWallet] = _tOwned[marketingWallet].add(tFee);
        emit Transfer(address(this), marketingWallet, tFee);
    }
    ...
    {  
        return _amount.mul(_liquidityFee.add(_marketingFee).add(_GafalaFee)).div(100);
    }
    ...
    {
        uint256 allFee = _liquidityFee.add(_marketingFee).add(_GafalaFee);
        ...
        GafalaWallet.transfer(newBalance.div(allFee).mul(_GafalaFee));
    }
    ...
    function setGafalaWallet(address newWallet) external onlyOwner() 
    {
        GafalaWallet = payable(newWallet);
    }
